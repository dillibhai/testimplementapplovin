...
class NativeViewAppLovin(context: Context, id: Int, creationParams: Map<String?, Any?>?) :
    ...
    init {
        ...
        loadNativeAd()
//        val customOptions  = mutableMapOf<String, Any>()
...
//        val layoutRes:Int = context.resources.getIdentifier(layout, "layout", "np.com.nepalipatro")
   //     rootView = layoutInflater.inflate(layoutRes, null) as NativeAdView
   //rootView=inflater.inflate(layoutRes, null) as NativeAdView
